...
static const GimpEnumActionEntry view_zoom_explicit_actions[] =
{
  ...
  { "view-zoom-1-2", NULL,
    ...
    { "<shift>2", "<shift>KP_2", "<shift>KP_Down", NULL },
  ...
  { "view-zoom-1-4", NULL,
    ...
    { "<shift>3", "<shift>KP_3", "<shift>KP_Page_Down", NULL },
  ...
  { "view-zoom-1-8", NULL,
    ...
    { "<shift>4", "<shift>KP_4", "<shift>KP_Left", NULL },
  ...
  { "view-zoom-1-16", NULL,
    ...
    { "<shift>5", "<shift>KP_5", "<shift>KP_Begin", NULL },
