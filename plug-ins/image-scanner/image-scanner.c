                      ...
                      GError              **error)
{
  ...
  g_signal_connect (select,
                    "changed",
                    G_CALLBACK (activate_scanner_callback),
                    list_view);
  ...
  /* show unset for init */
  res_store1 = gtk_list_store_new (1, G_TYPE_STRING);
  gtk_list_store_append (res_store1, &iter);
  ...
  res_store2 = gtk_list_store_new (1, G_TYPE_STRING);
  gtk_list_store_append (res_store2, &iter);
  ...
  res_store3 = gtk_list_store_new (1, G_TYPE_STRING);
  gtk_list_store_append (res_store3, &iter);
