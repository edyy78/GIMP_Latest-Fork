...
GimpTextVerticalJustification gimp_text_layer_get_vertical_justification  (GimpTextLayer                  *layer);
gboolean                      gimp_text_layer_set_vertical_justification  (GimpTextLayer                  *layer,
