...
#define GIMP_ICON_FORMAT_VERTICALLY_JUSTIFY_BOTTOM  "format-justify-bottom"
#define GIMP_ICON_FORMAT_VERTICALLY_JUSTIFY_MIDDLE  "format-justify-middle"
#define GIMP_ICON_FORMAT_VERTICALLY_JUSTIFY_TOP     "format-justify-top"
